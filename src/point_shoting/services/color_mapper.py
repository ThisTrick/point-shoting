...
class ColorMapper:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        self._stylized_palette: np.ndarray | None = None
        self._precise_image: np.ndarray | None = None
        self._image_width: int = 0
        self._image_height: int = 0

    def build_palettes(
        self, image: Image.Image, color_mode: ColorMode = ColorMode.STYLIZED
    ) -> None:
        """
    ...
    def get_stylized_palette(self) -> np.ndarray | None:
    ...
    def batch_color_assignment(
        self, target_positions: np.ndarray, color_mode: ColorMode = ColorMode.STYLIZED
    ) -> np.ndarray:
        """
    ...
    def calculate_delta_e_placeholder(
