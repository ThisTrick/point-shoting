...
class LocalizationProvider:
    ...
    def set_locale(self, locale: str) -> bool:
        ...
        if locale in self.translations:
            ...
            self.logger.warning(f"Locale not available: {locale}, keeping {self.current_locale}")
            return False
    ...
    def get_locale_info(self, locale: Optional[str] = None) -> Dict[str, str]:
        ...
        locale_name = self._get_text_from_locale(check_locale, "app.name") or check_locale
