...
class TestVisualArtifactsPrevention:
        ...
        with patch('PIL.Image.open', return_value=mock_image):
            ...
            for _ in range(10):  # Multiple update cycles
                ...
                if previous_stage is not None:
                    assert current_stage.value >= previous_stage.value or current_stage == Stage.PRE_START
    ...
    def test_no_particle_jumping(self):
        ...
        with patch('PIL.Image.open', return_value=mock_image):
            ...
            assert max_delta < 0.1, f"Particles moved too far in small time step: {max_delta}"
    ...
    def test_boundary_collision_smoothness(self):
        ...
        with patch('PIL.Image.open', return_value=mock_image):
            ...
            for _ in range(30):
                ...
                assert np.all(np.isfinite(positions)), "Invalid position values detected"
        ...
        with patch('PIL.Image.open', return_value=mock_image):
            ...
            if color_samples:
                ...
                if len(color_samples) > 1:
                    ...
                    assert max_variance < 1000, f"High color variance (flickering): {max_variance}"
