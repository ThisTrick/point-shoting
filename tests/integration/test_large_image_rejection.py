...
class TestLargeImageHandling:
    ...
    def test_large_image_behavior(self, tmp_path):
        ...
        try:
            ...
            assert any(
                ...
                for keyword in ["size", "resolution", "memory", "limit"]
    ...
    def test_accept_maximum_allowed_size(self, tmp_path):
        ...
        if init_success:
            ...
            assert any(
                keyword in error_msg for keyword in ["size", "resolution", "memory"]
    ...
    def test_memory_estimation_for_large_images(self, tmp_path):
        ...
        try:
            ...
            assert any(
                keyword in error_msg for keyword in ["memory", "limit", "resource"]
    ...
    def test_reject_non_image_file_with_image_extension(self, tmp_path):
        ...
        assert any(
            keyword in error_msg for keyword in ["image", "format", "load", "invalid"]
