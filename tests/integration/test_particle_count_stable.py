        ...
        with patch('src.point_shoting.services.particle_engine.Image.open') as mock_open:
            ...
            for step in range(50):
                ...
                if snapshot is not None and hasattr(snapshot, 'active'):
                    ...
                    inactive_count = (~active_particles).sum() if hasattr(active_particles, 'sum') else 0
                    
                    assert inactive_count == 0, f"Step {step}: {inactive_count} particles became inactive"
