...
class TestSettingsPersistence:
    ...
    def test_settings_save_and_load_cycle(self, tmp_path):
        ...
        assert loaded_settings.breathing_amplitude == original_settings.breathing_amplitude
        ...
        assert loaded_settings.chaos_min_duration == original_settings.chaos_min_duration
        assert loaded_settings.formation_fallback_time == original_settings.formation_fallback_time
        assert loaded_settings.stable_frames_threshold == original_settings.stable_frames_threshold
    ...
    def test_default_settings_when_file_missing(self, tmp_path):
        ...
        assert settings.hud_enabled == False
        assert settings.loop_mode == False
    ...
    def test_partial_settings_file_completion(self, tmp_path):
        ...
        assert settings.hud_enabled == False                  # Default
    ...
    def test_settings_update_preserves_unchanged_fields(self, tmp_path):
        ...
        assert loaded_settings.breathing_amplitude == initial_settings.breathing_amplitude
