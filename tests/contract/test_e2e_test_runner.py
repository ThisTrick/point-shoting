...
class TestE2ETestRunnerContract:
    ...
    def test_run_engine_e2e_tests_interface(self):
        ...
        # Invariants
        assert result.total_count == result.pass_count + result.fail_count + result.skip_count
    ...
    def test_test_suite_structure(self):
        ...
        # Invariant
        assert suite.total_count == suite.pass_count + suite.fail_count + suite.skip_count
